        ...
        <div className="relative mx-auto grid min-h-[720px] max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="relative">
            <div className="rounded-[2.5rem] border border-white/15 bg-white/10 p-4 shadow-2xl backdrop-blur">
              <div className="overflow-hidden rounded-[2rem] bg-[#FFF8EF]">
                <div className="flex min-h-[460px] flex-col justify-end bg-[linear-gradient(180deg,_rgba(255,248,239,0.05),_rgba(15,91,91,0.75)),url('https://images.unsplash.com/photo-1581579438747-104c53d7fbc4?auto=format&fit=crop&w=1200&q=80')] bg-cover bg-center p-8">
                  <div className="rounded-3xl bg-white/92 p-6 shadow-xl backdrop-blur">
                    ...
                    <p className="mt-3 text-sm leading-6 text-[#243232]/75">
                      Support for families making one of life’s most important
                      care decisions.
                    </p>
                  </div>
                </div>
